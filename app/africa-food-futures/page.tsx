                            ...
                            <div className="space-y-8">
                                ...
                                >
                                    <div className="md:w-1/3">
                                        <span className="text-[#F4C430] font-black tracking-widest block mb-1">Day 01</span>
                                ...
                                >
                                    <div className="md:w-1/3">
                                        <span className="text-[#F4C430] font-black tracking-widest block mb-1">Day 02</span>
                                ...
                                >
                                    ...
                                    <div className="relative z-10 flex flex-col md:flex-row gap-8 p-10">
                                        <div className="md:w-1/3">
                                            <span className="text-[#F4C430] font-black tracking-widest block mb-1">Day 03</span>
                    ...
                    <div className="container mx-auto px-6">
                        <div className="text-center mb-20">
                            ...
                            <p className="text-slate-500 max-w-2xl mx-auto text-xl">
                                Join policy makers, global investors, and tech leaders in March 2027.
                            </p>
                        </div>
                    ...
                    <div className="container mx-auto px-6">
                        <div className="grid md:grid-cols-4 gap-12">
                            ...
                            <div>
                                ...
                                <p className="text-slate-400 text-xs italic">Rwanda · March 2027</p>
                            </div>
                        </div>
                    </div>
                </footer>
