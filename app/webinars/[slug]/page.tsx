...
import WebinarRsvpForm from '@/components/catalyst-w/WebinarRsvpForm';
        ...
        <div className="min-h-screen bg-white text-[#0B2C24]">
            <section className="bg-[#0B2C24] text-white pt-28 pb-16 relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 max-w-5xl relative z-10">
                    ...
                    <div className="mt-10 grid sm:grid-cols-2 gap-4 text-sm max-w-2xl">
                ...
                <div className="container mx-auto px-6 max-w-5xl">
                    <div className="grid lg:grid-cols-[1fr_380px] gap-12 items-start">
                        ...
                        <div className="lg:sticky lg:top-24">
                            {!isPast ? (
                                <WebinarRsvpForm webinarId={webinar.id} webinarTitle={webinar.title} />
                            ) : (
                                <div id="register" className="bg-gray-100 rounded-2xl p-8 text-center text-gray-500 text-sm">
