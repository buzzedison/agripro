    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      ...
      <section className="relative h-screen flex items-center justify-center text-center px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="https://airtable.com/app0J1BYQpwnlLfwj/shrFCdQcmNqDRnmJj" 
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 bg-green-600 text-white rounded-full hover:bg-green-700 transition-all text-lg font-semibold shadow-lg hover:shadow-xl"
            >
              Reserve Your Spot
            </Link>
            <Link href="/greenmarket/vendors" className="px-8 py-4 bg-white text-green-600 border-2 border-green-600 rounded-full hover:bg-green-50 transition-all text-lg font-semibold shadow-lg hover:shadow-xl">
              Become a Vendor
            </Link>
      ...
      <section className="py-20 px-4 bg-green-800 text-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mb-12">
            <p className="text-xl mb-2">📅 When: Saturday, March 22nd, 2025 </p>
