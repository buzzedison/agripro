...
export default function GreenMarket() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg text-gray-600 mb-12 leading-relaxed">
            The Accra Green Market is a vibrant community event that brings together farmers, green entrepreneurs, and eco-conscious individuals to showcase sustainable products, share innovative ideas, and inspire action. Whether you're a farmer, innovator, or just someone passionate about the planet, this is your chance to be part of the change.
          </p>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="py-12 px-4 bg-green-900 text-white">
        <div className="max-w-5xl mx-auto text-center">
          <p className="mb-6">Follow us for updates and green living tips:</p>
          ...
          <p className="text-green-300 font-semibold">Accra Green Market | Grow Green, Live Clean</p>
        </div>
      </footer>
    </div>
  );
