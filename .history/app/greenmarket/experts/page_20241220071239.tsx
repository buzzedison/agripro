      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-green-800 mb-6">
            Call for Experts.  <br/> <span className="font-normal text-3xl ">Facilitate a Session at the Accra Green Market</span>
          </h1>
        ...
        <section className="text-center mb-16">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <p className="text-gray-700">📧 Email us at: <a href="mailto:info@agriprohub.com" className="text-green-600 hover:text-green-700">contact@accragreenmarket.com</a></p>
              <p className="text-gray-700">📞 Call us at: <a href="tel:+233245600275" className="text-green-600 hover:text-green-700">+233 00 000 0000</a></p>
            </div>
