          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link 
                  href="mailto:volunteers@agriprohub.com?subject=Join%20a%20Club%20Inquiry"
                ...
                <Link 
                  href="mailto:volunteers@agriprohub.com?subject=Start%20a%20Club%20Inquiry"
              ...
              {/* <div className="mt-12 grid grid-cols-3 gap-8 pt-8 border-t border-white/20">
                <div>
                  ...
                  <div className="text-sm text-green-100">Active Clubs</div>
                </div>
                <div>
