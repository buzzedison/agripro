-- 045_add_views_to_network_feed_rpc.sql
-- get_network_feed didn't return views_count (added in 044), so the "For You"
-- tab would show it as undefined while the "Following" tab (a plain select *)
-- would not. Add it to the RPC's return columns so both tabs match.
